...
public class MedDepartment extends Department {


    public MedDepartment(String deanName, DepartmentCode departmentCode, int departmentTotalStudent) {
    ...
    public void displayDepartmentInfo() {
        ...
        System.out.println("Dean name: " + this.getDeanName());
